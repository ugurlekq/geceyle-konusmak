...
export default function MembershipPitch() {
    return (
        <section className="relative z-10 mx-auto max-w-3xl px-6 mt-12">
            <motion.div initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.8}}>
                ...
                <div className="mt-5">
                    <a href="/subscribe" className="inline-flex items-center rounded-xl border border-amber-400 text-amber-300 px-5 py-2.5 hover:bg-amber-400 hover:text-black transition">
                        Üyeliği İncele →
                    </a>
                </div>
            </motion.div>
